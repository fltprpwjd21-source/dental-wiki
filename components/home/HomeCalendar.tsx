...
//   주황은 두 바탕 모두에서 튄다.
//
// 주황은 「공지에서 지정한 날짜」 전용으로 예약된 색이다.
//   앞으로 캘린더에 다른 종류(기공물 도착 예정일, 근무표 등)를 얹더라도
//   파랑 계열이나 다른 색을 쓰고 주황을 재사용하지 않는다 —
//   색이 겹치는 순간 "이 점이 무슨 뜻이냐"를 매번 물어보게 된다.
//   (DESIGN.md "캘린더 표시색 (예약)" 참고)
//
